...
\TODO{Could add something on scale of impact. Estimate Juptyer users, estimate
  binder users: say this are most directly impacted from the improvements. Then
  all others scientists, educators, ...?}
The majority of scientists use some form of computational
(Section~\ref{sec:motivation-why}) to generate their publications and scientific
outputs. XXX


\TODO{Or integrate into table above?}
\TODO{Skip if short of space or time.}
