...
or require reproducibility of scientific outputs. Beyond Binder, underlying software components such as \repotodocker{}
are used in other parts of the ecosystem to enable the customisation of software environments. This is of particular 
interest for several of the science applications depicted in the project but also other Jupyter-based platforms 
currently deployed for research and education, for instance on EOSC (EGI notebook), at the University of Oslo and/or 
in other Norwegian Universities through Sigma2 (the Norwegian National e-infrastructure Provider). 
