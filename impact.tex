...
using developments made in \WPref{applications} is also a dissemination activity: services like Binder not only 
...
including institutional subscription models, donations, and others. \TheProject will also actively seek for
collaboration (through the CEP and \TheProject partners) with existing EOSC projects (many already use/deploy 
Jupyter Notebook services) to inform and support them in exploiting  \TheProject developments and adapting their
service offerings.

\begin{framed}

  \centerline{\textbf{ \TheProject DRAFT COMMUNICATIO, DISSEMINATION and EXPLOITATION }}
  {
  \begin{itemize}
...
As indicated in our draft dissemination, communication and exploitation plan, we will operate a \textbf{website}
