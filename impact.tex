...
% Xeus (\taskref{ecosystem}{xeus-cpp}).
...
\eucommentary{
(5 pages including 2.3)
Describe planned measures to maximise impact by providing first version of ``plan for the dissemination and exploitation including communication activities''
If funded, we need to provide a corresponding deliverable within 6 months after the signing date.
Outline strategy for management of intellectual property …
}
