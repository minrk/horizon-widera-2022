...
from large-scale simulations to production of simple charts and figures.
...
We are not solving the \emph{whole reproducibility problem},
but we \emph{are} solving a big piece of the problem (\textbf{reproducible computational environments}) in a way that can be reused,
and mixed and matched with any number of solutions to other parts of the reproducibility problem,
such as workflow execution.
This reuse means other projects can focus on their part of the problem,
without reimplementing a solution of software environments,
improving the impact and efficiency of those projects, in turn.
...
Reproducibility is a widely recognised challenge in computational science.
...
are used in other parts of the ecosystem to enable the customisation of software environments. This is the case in the
