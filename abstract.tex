...
This project is automates and improves ways to do this by developing and extending the
Binder project.
...
We aim to bring this potential to users not yet served by the tools,
by extending the robustness and the applicability of the
Binder tools to fill those gaps.
