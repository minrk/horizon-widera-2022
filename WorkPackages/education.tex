...
\begin{wpdescription}
  ...
  \item The philosophy of the Binder tools is to respect existing standards and
    ...
    output becomes automatically reproducible with Binder \textbf{without the
    author having to know} about Binder or \textbf{having to invest additional
      effort} (beyond following best practice).

    \item In this work package, we produce education materials and carry out
      education activities to spread the knowledge about \myemph{good practice for
    ...
    \item Throughout the activities of this project and the engagement with the
      wider science community through the Community Engagement Panel, we aim to \textbf{understand 
      the underlying drivers} for
      acceptance, rejection or lack-of-interest \textbf{in adopting practices that lead
  ...
  % TO: thats a very good idia, i think i saw somewhere open science also include citizen science for some european calls  ... i can't find the right link though...

  Science applications (\WPref{applications}) will also support the creation
   of tutorials and \myemph{best practice guides for
    reproducibility} (\taskref{education}{online-resources}), and
  offer interactive (online, hybrid and/or in-person) workshops (\taskref{education}{workshops}) 
  to help disseminate the content more effectively.

  We will participate in the well established academic dissemination
