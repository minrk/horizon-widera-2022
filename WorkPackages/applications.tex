...
\begin{wpdescription}
  ...
  \begin{compactitem}
  \item \taskref{applications}{demos} Applications and best practice examples that
    demonstrate use of Binder for more reproducible and reusable science.
  \item \taskref{applications}{binder-at-home} Ability to recreate software environments
    and re-produce results using local compute resources (such as the Desktop of
    a researcher)
  \item \taskref{applications}{data-publishing} Use of Binder to facilitate access to
  ...
  \item \taskref{applications}{binder-at-hpc} Use of Binder at High Performance Computing
...
%   \pageref{sec:science-demonstrators-in-concept}.
  ...
  The tasks in this work package serve both
  as requirements capture (and so to inform and guide the
  work in \WPref{reproducibility} and \WPref{impact}) and evaluation of the
  technological advances of the Binder tools. The completed demonstrators will
  also feature in our best practice guidelines and dissemination activities
  in~\WPref{education}.

  We will use the regular technical reports to update on progress. An
  interim report (\delivref{applications}{report-use-cases-interim}) and final
  report (\delivref{applications}{report-use-cases}) will summarise the results.
