...
The MyBinder federation (see \ref{sec:mybinder}) is a federation of
organisations that collectively host a service running the Binder software
(\url{https://mybinder.org}). This is the service we made use of in our example
in section~\ref{sec:reproducibility-example}.
