...
- Consistency
  - [ ] Section or section or Sect or Sec. - Section
  - [ ] Figure or figure or Fig or Fig. - Figure
  - [ ] Binder or binder - Binder
  - [ ] MyBinder or Mybinder or mybinder - let's use `mybinder.org` for the public instance of the service

- [ ] Add binder usage numbers to proposal (Hans/Min have those),
      probably best in mybinder section.
...
- [ ] have a generic section on reproducibility and things we talk about here
  ...
  - [ ] executing a notebook in this environment (step B)
...
- [ ] LaTeX layout items
  - [x] can we switch the citation style so that we use [1], [2], [3], instead
...
'usepackage[maxbibnames=6,hyperref=auto,style=numeric,backend=biber]{biblatex}'.
