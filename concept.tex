...
For clarity, we define a few terms that we refer to through this proposal:
...
\TODO{Create example and refer to it here?}
...
\item[Software specification] XXX

\item[Software environment] All the software that needs to be available to
execute the scripts and (and if desired) Jupyter notebooks. 
