...
\textbf{impactful} and \textbf{socially responsible}, should be done
\textbf{publicly}, with as much of the scientific process and products
\textbf{accessible, reviewable, and reusable} by as many members of the global
community as possible. In the modern age of computational science, almost all
academic fields, from humanities to social sciences to biology and astronomy are
presented with exciting opportunities for Open Science. As more and more
research takes the form of code and/or data, the opportunity to share,
reproduce, and reuse scientific work is greater than ever, even enabling new
forms of \textbf{interdisciplinary collaboration}.
...
are corresponding challenges, technical and social, to making Open Science
...
\begin{itemize}
\item The work done is this project will \emph{support} scientists in their
  endavours to make their work more reproducible and re-usable.
\item We believe in \emph{open} science and open source. The best
  reproducibility and re-usability of is given through complete transparency of
  the (computational) steps taken in the derivation of a result, and by making
  all simulation and/or post-processing and analysis steps open source. While
  this may not always be possible, we advocate this as the best practice for
  reproducible science.

  All work done and delivered through this project will be open source.
...
\item Within the wide field of reproducibility in science, we focus in this
  project on the improvement of the automatic generation of {reproducible
    computational environments}.
\end{itemize}

In the following sections, we \TODO{Provide overview of next sections.}
