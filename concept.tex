...
Our science applications (Figure \ref{fig:applications}) follow the workflow outlined in
\ref{fig:use-cases-binder}, and include these examples: \TODO{Mention that some of our science applications need
...
\item \TODO{Add examples from UiO. Some placeholder text. Some placeholder
    text.Some placeholder text.Some placeholder text. Some placeholder text.Some
    placeholder text. Some placeholder text. Some placeholder text. Some
    placeholder text. Some placeholder text. Some placeholder text. }
\end{itemize}
...
\begin{figure}
  ...
  \caption{Selected domains from our use cases. From left to right: interactive
    ...
    density of benzene molecule computed with Octopus.
