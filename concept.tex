...
study starts at the point where such experimental data is available
electronically.

We will focus on the challenge of electronic reproducibility: can we carry out
...
The challenges of such ``electronic reproducibility'' include:
\begin{itemize}
...
machine-executable script (or Jupyter notebook).
...
to orchestrate the execution of commands seems effective.\footnote{\TODO{Add
citations here, at least Marijan Beg et al.
https://ieeexplore.ieee.org/document/9325550}} The use of the notebook is
perceived by many as an improvement of their research effectiveness in because
it supports ``Thinking with Code and Data'' \footnote{\TODO{Cite last year's paper by
Fernando and Brian: https://doi.org/10.1109/MCSE.2021.3059263}}. A such, the
...
The \emph{Other} challenges are primarily outside the focus of this work
(although our proposal will also assist in reproducible and FAIR data
publishing, see \TODO{Insert data publishing use case Task reference}).


\paragraph{Terminology - Work in progress}\TOWRITE{}{Hans to continue here}

We assume that researchers have carried out a study, and that they want to
publish a \emph{repository} of electronic files that help to make this work
reproducible.
