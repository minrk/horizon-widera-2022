...
\item To prepare the more detailed description of the concept and the content of
  ...
  \fullref{sec:reproducibility-example} to introduce key terminology
...
\TOWRITE{}{
  \begin{compactitem}
\item   1 page: National or international research or innovation activities
\item 0.5 page: bringing together expertise and methods from different disciplines
\item 0.5 page: social science and humanities - how do we integrate them, or why do we not need them
\item 1 page: gender dimension. How taken into account in the research content (not the research team). Or justify why not relevant.
\item 1 page: open science practices and implementation
\item 1 page: research data management and management of other research outputs. (Also FAIR)
\end{compactitem}
}
