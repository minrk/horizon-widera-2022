...
\paragraph*{Context:}
Reproducibility services using Binder currently rely on hosted Binder instances.
E.g., the mybinder federation provides such a global service at mybinder.org
which is free at
