...
This task includes the following activities:
  ...
  \item Develop lesson materials on \myemph{open science} best practices (version
    ...
    notebooks).
  \item Develop lesson materials on \myemph{reproducible computational science},
    which focuses on combining the open science tools for reproducible science.
  \item Develop materials on \myemph{using Binder tools to make science more
